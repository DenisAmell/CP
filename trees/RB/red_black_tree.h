...
private:
    ...
    protected:
            ...
            public binary_search_tree<tkey, tvalue, tkey_comparer>::insertion_template_method
        {
            ...
            public:
                red_black_insertion_template_method ( red_black_tree<tkey, tvalue, tkey_comparer> * tree) : 
                        _tree(tree), 
...
{
    if (subtree_root_address->right_subtree_address == nullptr && subtree_root_address->left_subtree_address == nullptr)
    {
        ...
        if (!path_to_subtree_root_exclusive.empty())
        {
            _rise_near_status = (*path_to_subtree_root_exclusive.top())->left_subtree_address == subtree_root_address ?
                    rise_status::FROM_LEFT_SUBTREE : rise_status::FROM_RIGHT_SUBTREE;
        }
    ...
    {
        (reinterpret_cast <typename red_black_tree<tkey, tvalue, tkey_comparer>::red_black_node*> (subtree_root_address))->color = color_node::RED;
        ...
        (reinterpret_cast <typename red_black_tree<tkey, tvalue, tkey_comparer>::red_black_node*> (subtree_root_address))->color = color_node::BLACK;
    ...
    {
        (reinterpret_cast <typename red_black_tree<tkey, tvalue, tkey_comparer>::red_black_node*> (subtree_root_address))->color = color_node::RED;
        uncle->color = color_node::BLACK;
        (*parent)->color = color_node::BLACK;
...
template<
    ...
    typename tvalue,
    typename tkey_comparer>
void red_black_tree<tkey, tvalue, tkey_comparer>::red_black_insertion_template_method::constructor_node(typename binary_search_tree<tkey, tvalue, tkey_comparer>:: node* ptr_node) const
{
    new (ptr_node) typename red_black_tree<tkey, tvalue, tkey_comparer>::red_black_node;
}
...
red_black_tree<tkey, tvalue, tkey_comparer>::red_black_tree(
            memory* allocator,
            logger* logger) : binary_search_tree<tkey, tvalue, tkey_comparer>(
