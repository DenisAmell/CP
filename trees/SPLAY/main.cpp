...
int main()
{
	...
	memory* allocator = new memory_list(nullptr, log, 100000, memory::allocate_mode::first_fit);
	...
	std::string add = splay->remove(15);
	std::cout << "removing complete, removed value: " << add << std::endl;
	/*std::string add = splay->remove(15);*/
	// avl->remove(2);
