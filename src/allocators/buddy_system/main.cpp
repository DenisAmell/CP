	...
	unsigned int iterations_count)
{
	...
	memory* allocator = new buddy_system(log, nullptr, 20, memory::allocate_mode::best_fit);
...
void allocator_demo_2()
{
	...
	memory* allocator = new buddy_system(log, nullptr, 10, memory::allocate_mode::first_fit);
