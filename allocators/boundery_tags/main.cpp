    ...
    unsigned int iterations_count)
{
    ...
    memory* allocator = new boundery_tags(log, nullptr, 1000000, memory::allocate_mode::best_fit);
...
void allocator_demo_2()
{
    ...
    memory* allocator = new boundery_tags(log, nullptr, 1000000, memory::allocate_mode::first_fit);
